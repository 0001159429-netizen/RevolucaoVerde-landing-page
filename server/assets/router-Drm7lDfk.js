...
const appCss = "/RevolucaoVerde-landing-page/assets/styles-ilPsqdNq.css";
...
const $$splitComponentImporter = () => import("./index-DBP3Sm8s.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Transformando a manutenção industrial com inteligência artificial. Diagnóstico preditivo, monitoramento em tempo real e redução de custos."
    }]
  })
});
